...
class Cifra_de_Vigenere():
    def __init__(self, chave):
        ...
        # Filtra a chave para remover acentos, garantindo que apenas letras válidas sejam usadas na cifra.
        self.key = self.remover_acentos(chave.upper())
        if not self.key:
            raise ValueError('A chave deve conter pelo menos uma letra válida do alfabeto.')
        # adicionar ainda filtragem para converter números em letras, caso seja necessário, ou para lidar com caracteres especiais.  
